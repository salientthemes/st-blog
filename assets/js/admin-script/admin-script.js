jQuery(window).load(function() {
	...
	st_blog_feature_setting_show_hide( jQuery('#customize-control-salient_customizer_options-st-blog-trending-select-post-from select').val(), '#sub-accordion-section-st-blog-trending-section' );
	...
	jQuery('#customize-control-salient_customizer_options-st-blog-trending-select-post-from select').on('change', function() {
		st_blog_feature_setting_show_hide(this.value, '#sub-accordion-section-st-blog-trending-section');		
	});
});
