...
if ( !class_exists('salient_sidebar_widget_world') ) :
	...
	class salient_sidebar_widget_world extends WP_Widget
	{
		...
		{
			parent :: __construct(
				'st-blog-sidebar-tab-widget',   // base_id
				esc_html__('ST  Slider Widget','st-blog'),  //name
		...
		function form ( $instance )
		    {
		        ...
		        <p>
		            <label for="<?php echo absint($this->get_field_id( 'post_category' )); ?>"><?php esc_html_e( 'Category:', 'st-blog' ); ?></label>
		            <?php
		            $cat_args = array(
		                'orderby'         => 'name',
		                'hide_empty'      => 0,
		        ...
		        <p>
		            <label for="<?php echo absint($this->get_field_id( 'post_number' )); ?>"><?php esc_html_e('Number of Posts:', 'st-blog' ); ?></label>
		        ...
		        <p>
		            <label for="<?php echo esc_html($this->get_field_id( 'custom_class' )); ?>"><?php esc_html_e( 'Custom Class:', 'st-blog' ); ?></label>
	    ...
	    add_action( 'widgets_init', 'st_blog_tab_world_widget_load' );

	    if ( ! function_exists( 'st_blog_tab_world_widget_load' ) ) :
	         ...
	         *
	         */
	        function st_blog_tab_world_widget_load()
	        {
	            // Latest News widget
