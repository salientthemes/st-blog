...
if ( ! class_exists( 'st_blog_tab_widget' ) ) :
    ...
    class st_blog_tab_widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id('business_heading')); ?>"><?php esc_html_e( 'Tab2 Heading Title:', 'st-blog' ); ?></label>
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id( 'business_category' )); ?>"><?php esc_html_e( 'Tab2 Category:', 'st-blog' ); ?></label>
                <?php
                $cat_args = array(
                    'orderby'         => 'name',
                    'hide_empty'      => 0,
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id( 'business_number' )); ?>"><?php esc_html_e('Number of tab2 Posts:', 'st-blog' ); ?></label>
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id('sport_heading')); ?>"><?php esc_html_e( 'Tab3 Heading Title:', 'st-blog' ); ?></label>
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id( 'sport_category' )); ?>"><?php esc_html_e( 'tab3 Category:', 'st-blog' ); ?></label>
                <?php
                $cat_args = array(
                    'orderby'         => 'name',
                    'hide_empty'      => 0,
            ...
            <p>
                <label for="<?php echo absint($this->get_field_id( 'sport_number' )); ?>"><?php esc_html_e('Number of tab3 Posts:', 'st-blog' ); ?></label>
    ...
    add_action( 'widgets_init', 'st_blog_recent_sidebar_tab_post' );

    if ( ! function_exists( 'st_blog_recent_sidebar_tab_post' ) ) :
         ...
         *
         */
        function st_blog_recent_sidebar_tab_post(){
            // Latest News widget
